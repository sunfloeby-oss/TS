...
const FAQS = [
  {
    ...
    answer:
      "Tidak. Terrashop20 tidak menggunakan akun pelanggan — menjelajah, keranjang, wishlist, dan checkout semuanya bisa dilakukan sebagai tamu. Anda hanya perlu nama, nomor telepon, dan email untuk membuat pesanan.",
  },
  {
        ...
        <section className="bg-paper py-16 sm:py-24">
          <Container className="flex flex-col gap-10">
            <SectionHeading
              ...
              description="Semua yang perlu Anda ketahui tentang memesan, membayar, dan melacak pesanan di Terrashop20."
            />
