...
// Instagram is currently the only channel Terrashop20 is active on — keep
// this list to what's real rather than padding it with unused platforms.
const socialLinks = [
  {
    label: "Instagram",
    href: "https://instagram.com/terrashop20",
    icon: InstagramIcon,
  },
] as const;
        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-9 sm:grid-cols-5 sm:gap-10">
          <div className="col-span-2 flex flex-col gap-3.5 sm:col-span-1 sm:gap-4">
            ...
            <p className="max-w-[220px] text-sm leading-relaxed text-slate">
              Tas branded preloved pilihan, terverifikasi asli untuk Anda.
            </p>
