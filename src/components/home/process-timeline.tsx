import { BadgeCheck, PackageCheck, Search, ShieldCheck } from "lucide-react";
...
const steps = [
  {
    ...
    title: "Kurasi",
    description:
      "Setiap tas diseleksi langsung dari sumber terpercaya, memilih hanya piece bermerek dengan kondisi terbaik.",
  },
  {
    icon: BadgeCheck,
    title: "Autentikasi",
    description:
      "Diperiksa detail demi detail oleh tim kami untuk memastikan keasliannya sebelum masuk katalog.",
  },
  {
    icon: ShieldCheck,
    title: "Kontrol Kualitas",
    description:
      "Dibersihkan dan diperiksa ulang kondisinya, sehingga siap dipakai begitu sampai di tangan Anda.",
  },
  {
    icon: PackageCheck,
    title: "Sampai ke Anda",
    description:
      "Dikemas dengan rapi dan dikirim langsung ke tangan Anda, lengkap dengan detail keasliannya.",
  },
];
    ...
    <section className="bg-cloud py-14 sm:py-32">
      <Container className="flex flex-col gap-8 px-5 sm:gap-14 sm:px-6">
        <Reveal variant="fade-up" duration={DURATION} easing={EASING}>
          <SectionHeading
            eyebrow="Proses kami"
            title="Perjalanan Setiap Tas"
            description="Setiap tas preloved melewati proses kurasi dan pemeriksaan ketat, memastikan kualitas dan keasliannya sebelum sampai ke tangan Anda."
            compact
          />
        </Reveal>
