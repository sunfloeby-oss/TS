...
export async function generateInvoicePdf(order: InvoiceOrder): Promise<Buffer> {
  ...
  doc
    ...
    .fontSize(16)
    .fillColor(INK)
    .text("Terrashop20", 104, 50);
  doc
    .font("Helvetica")
    .fontSize(9)
    .fillColor(SLATE)
    // TODO: replace with Terrashop20's actual business address.
    .text("Tas Premium Branded Preloved", 104, 70);
  ...
  doc
    ...
    .fillColor(SLATE)
    .text(
      "Thank you for shopping with Terrashop20 — premium branded preloved bags.",
      50,
      760,
