...
const FROM_EMAIL = process.env.RESEND_FROM_EMAIL ?? "Terrashop20 <orders@terrashop20.com>";
...
// Terrashop20 design tokens (see app/globals.css :root) — duplicated here
            ...
            <tr>
              <td class="lk-px" style="padding:24px 40px 32px 40px; border-top:1px solid ${COLOR.line};">
                <p style="margin:0; font-size:12px; line-height:1.6; color:${COLOR.slate};">
                  Terrashop20 — tas premium branded preloved, diautentikasi
                  dan diperiksa kondisinya sebelum sampai ke tangan Anda.
                </p>
              </td>
            </tr>
          </table>
